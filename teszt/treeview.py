...
treeview.insert('', '3', 'item4', text ='Tudomány')
treeview.insert('', 'end', 'item5', text ='Programming Languages')
...
treeview.insert('item3', 'end', '2020 paper', text ='2020 paper')
treeview.insert('item4', 'end', 'Tudás', text ='Tudás')
treeview.insert('item5', 'end', 'Python', text ='Python')
treeview.insert('item5', 'end', 'Java', text ='Java')
